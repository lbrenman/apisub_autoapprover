...
module.exports = {
	...
	// API key
	// apikey: 'yVmhgON3EtrIZwHMb5slN+KpliL3Tirs',
  apikey: process.env.apikey,
	...
	session: {
		...
		encryptionKey: 'jslFaN7OMgI55X9ScnorT4ZrC8LZShertagFSRQtYK4=',
		signatureAlgorithm: 'sha512-drop256',
		signatureKey: 'fANBR/ZaCrypPqfl0BWC+0vIZSGFGHMwzpyqe+o8+OnidT7PvUfLJG/qnucnGJnOyl7zb8iwEYTPp2Ril2+MAw==',
		// should be a large unguessable string
		secret: 'bwNfbtk5m2y9tJwzF7Vh54k6xpNk4L7v',
	...
	cookieSecret: 'yzPRO9xf8cwU4ApeRpQQTgfQo+fon71X',
